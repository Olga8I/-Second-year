...
public class House {
    ...
    public void vivod()
    {
        System.out.println("Óíèêàëüíûé èäåíòèôèêàòîð êâàðòèðû:"+id+"\nÍîìåð êâàðòèðû:"+numberHouse+"\nÝòàæ:"+stage+"\nÏëîùàäü:"+area+"\nÒèï çäàíèÿ:"+typeBuilding+"\nÓëèöà:"+street+"\nÊîëè÷åñòâî êîìíàò:"+countRoom+"\nÑðîê ýêñïëóàòàöèè:"+lifeTime+"\n");
    }
     public void vivod()
    {
